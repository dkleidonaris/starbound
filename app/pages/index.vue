  ...
  <div>
    <div class="h-screen bg-[url('/img/starry_bg.jpg')] bg-cover bg-fixed">
      ...
      >
        ...
        />
        <p
          class="text-[#7761e0] text-center text-4xl md:text-6xl font-bold tracking-wide text-shadow-md"
        >
          {{ $t("headings.homepage.title1") }}
        </p>
        <p
          class="text-[#7761e0] text-center text-4xl md:text-6xl font-bold tracking-wide text-shadow-lg"
        >
